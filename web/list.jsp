...
<div class="wrapper">
    <div class="header">
        <div class="menu">
            <span>当前用户：<%=user.getUname()%></span><span></span>
    ...
    <div class="content">
        <ul>
            ...
            <li>
                ...
                <span class="bordstyle"><%=message.getMtitle()%></span><span><a href="message.do?action=query&id=<%=message.getId()%>"><%=message.getMcontent()%></a></span>
                <span class="rfloat">
